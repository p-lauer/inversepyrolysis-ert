...
sample_leafs = [1, ]  # SET OF MIN. NUMBER OF SAMPLE LEAFS
...
hrrlist = [(0, 1, 2, 3)]
gridlist = list(itertools.product(estimators, sample_leafs, hrrlist, bootstrap))
...
for i in gridlist:
    ...
    clf = ExtraTreesClassifier(n_estimators=i[0], min_samples_leaf=i[1], bootstrap=i[3], n_jobs=cores, random_state=2)
